...
class Parameters:
    ...
    @staticmethod
    def _aux_print_array_parameters(data: "Parameters") -> list[PARAMETERS]:
    ...
    @staticmethod
    def _aux_print_parameters(data: dict[str, "Parameters"]) -> dict[str, PARAMETERS]:
    ...
    @staticmethod
    def _create_dict_parameters(data: dict[str, PARAMETERS]) -> dict[str, "Parameters"]:
