...
class Parameters:
    ...
    def set_array(self, val: list[PARAMETERS]) -> None:
    ...
    @classmethod
    def _create_array_parameters(cls, value: list[PARAMETERS]) -> "Parameters":
    ...
    @staticmethod
    def _aux_print_array_parameters(input: "Parameters") -> list[PARAMETERS]:
    ...
    @staticmethod
    def _aux_print_parameters(input: dict[str, "Parameters"]) -> dict[str, PARAMETERS]:
    ...
    @staticmethod
    def _create_dict_parameters(input: dict[str, PARAMETERS]) -> dict[str, "Parameters"]:
